                            ...
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body card-dashboard">
                                        ...
                                        @endif
                                        <table data-ajax-url="{{ route('user-card-list') }}" class="table table-striped table-hover responsive table-bordered" id="editable-sample" data-order-type="DESC" data-order-cols="1">
                                            <thead>
                                                <tr>                                                
                                                ...
                                                <th data-table-search="true" data-table-sort="true" data-name="card_info" id="card_info">User Card Information</th>
