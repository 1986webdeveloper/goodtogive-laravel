                            ...
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        ...
                                        <form class="form" action="{{ route('action-edit-group-task') }}" method="POST">
                                            @csrf
                                              <input type="hidden" name="id" value="{{ $taskgroupdetail->id }}">
                                                ...
                                                <div class="row">
                                                     <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="group_title" id="userinput1" class="form-control" placeholder="Title" value="{{$taskgroupdetail->group_title}}">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="c-select form-control" id="location1" name="church_id">
                                                                ...
                                                                @foreach($userList as $user)
                                                                    <option value="{{ $user->id }}" {{ $user->id == $taskgroupdetail->church_id ? 'selected' : ''}}>{{ $user->firstname }} {{ $user->lastname }}</option>
                                                                @endforeach
                                                            </select>
                                                            <span class="focus-border"></span>
                                                        </div>
