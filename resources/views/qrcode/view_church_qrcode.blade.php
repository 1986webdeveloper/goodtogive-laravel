                                        ...
                                        <form class="form" action="{{ route('action-project-slab-edit') }}" method="POST">
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group" id="download_png">
                                                            ...
                                                            @else
                                                                <div class="text-left">
                                                                    <a href="#"  class="btn btn-primary" id="church_generate_qr_code">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label for="qrcode">Visitor Qr Code</label>
                                                            <input type="text" id="qrcode_visitor" class="form-control" placeholder="Qr Code" value="{{ $user->qrcode_visitor }}" readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group" id="download_png">
                                                            @if($user->qrcode_visitor != "")
                                                                <label for="userinput3">Visitor Qr Code Image</label>
                                                                <img src="data:image/png;base64, {!! base64_encode(QrCode::format('png')->size(300)->generate($user->qrcode_visitor))!!} ">
                                                                
                                                                <div class="text-left">
                                                                    <a href="data:image/png;base64, {!! base64_encode(QrCode::format('png')->margin(1)->size(300)->generate($user->qrcode_visitor))!!}"  class="btn btn-primary"id="download_qr_code" download="{{ $user->firstname }}-{{ $user->id }}">
                                                                        <i class="la la-check-square-o"></i> Download Visitor Qr Code
                                                                    </a>
                                                                </div>
                                                            @else
                                                                <div class="text-left">
                                                                    <a href="#"  class="btn btn-primary" id="church_generate_qr_code_vistor">
                                                                        <i class="la la-check-square-o"></i> Generate visitor Qr Code
                                                                    </a>
                                                                </div>
                                                            @endif
                                                            <!-- <div class="text-left">
