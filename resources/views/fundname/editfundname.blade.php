                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        @if ($errors->any())
                                            ...
                                            @endif
                                        <form class="form" action="{{ route('action-fundname-edit') }}" method="POST">
                                            @csrf
                                            <input type="hidden" name="id" value="{{ $churchfund->id }}" />
                                            <div class="form-body">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="c-select form-control" id="location1" name="church_id">
                                                                ...
                                                                @foreach($church_list as $church)
                                                                    <option value="{{ $church->id }}" {{ $church->id == $churchfund->church_id ? 'selected' : ''}}>{{ $church->firstname }}  {{ $church->lastname }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="userinput3" class="form-control" placeholder="Fund Name" name="name" value="{{ $churchfund->name }}" >
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
